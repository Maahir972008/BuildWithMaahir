...
// Form submission toast with improved accessibility
...
if (form) {
    form.addEventListener('submit', async function(e) {
        ...
        submitBtn.innerHTML = '<i class="fas fa-spinner fa-pulse" aria-hidden="true"></i> Sending...';
...
function showErrorToast(message) {
    ...
    errorToast.innerHTML = `<i class="fas fa-exclamation-triangle" aria-hidden="true"></i> <span>${message}</span>`;
